...
const ShopChangeForgetPasswordPage = () => {
  ...
  const submitHandler = async (values) => {
    await axios
      .put(
        `https://ecommerce-server-ajsh.onrender.com/shop/change-forget-password/${token}`,
        {
...
export default ShopChangeForgetPasswordPage;
